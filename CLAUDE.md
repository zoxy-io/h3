...
- [docs/VERIFICATION.md](docs/VERIFICATION.md) — what the evidence is, how
  each gate came to exist, and the fifty-odd defects they found. A slice is not
  done until it has a ledger citation and, where the behaviour is reachable from
  a connection, a simulator scenario or a census row.
